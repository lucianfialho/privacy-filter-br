...
MODEL = os.environ.get("MODEL_ID", "lucianfialho/privacy-filter-br-v4")
...
with gr.Blocks(title="Privacy Filter BR v4", theme=gr.themes.Soft()) as demo:
    gr.Markdown(
        """
        # 🇧🇷 Privacy Filter BR v4 — Demo
        ...
        - Modelo: [`lucianfialho/privacy-filter-br-v4`](https://huggingface.co/lucianfialho/privacy-filter-br-v4) — BERTimbau 110M, F1 micro 0.9992
